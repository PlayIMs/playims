...
<div class="w-full space-y-4">
	...
	<div class="px-4 lg:px-6 space-y-3">
		...
		>
			<div
				class="px-2 py-2.5 text-center border-r border-neutral-200 {(data.stats?.liveGames ?? 0) > 0
					? 'bg-primary-50'
					: ''}"
			>
				<p
					class="text-2xl font-bold font-serif {(data.stats?.liveGames ?? 0) > 0
						? 'text-primary-700'
						: 'text-neutral-950'}"
				>
				...
				<p
					class="text-[10px] uppercase tracking-wider font-bold {(data.stats?.liveGames ?? 0) > 0
						? 'text-primary-600'
						: 'text-neutral-600'} font-sans"
				>
					Live
				</p>
			</div>
			<div class="px-2 py-2.5 text-center border-r border-neutral-200">
				...
				<p class="text-[10px] uppercase tracking-wider font-bold text-neutral-600 font-sans">
					Today
				</p>
			</div>
			<div class="px-2 py-2.5 text-center border-r border-neutral-200 max-md:border-r-0">
				<p class="text-2xl font-bold font-serif text-neutral-950">
			...
			<div class="px-2 py-2.5 text-center max-md:border-t max-md:border-neutral-200">
				<p class="text-2xl font-bold font-serif text-neutral-950">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3 items-start">
						...
						<div class="divide-y divide-neutral-300 max-h-[200px] overflow-y-auto">
							{#each upcomingEvents as game}
								<div class="px-3 py-1.5 flex items-center gap-2 text-xs hover:bg-white/50">
									...
									<span
										class="shrink-0 text-neutral-500 font-sans hidden sm:inline truncate max-w-20"
									>
										{game.sport}
									</span>
								</div>
					...
					<section class="border-2 border-neutral-950 bg-neutral">
						...
						<div class="p-3">
							<div class="flex items-center gap-2 mb-2">
								<div class="bg-neutral-950 text-white p-1.5 shrink-0" aria-hidden="true">
							...
							<div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-neutral-950 font-sans">
								...
								<span class="font-semibold">
									{currentSeason.offeringCount} offering{currentSeason.offeringCount !== 1
										? 's'
										: ''}
								</span>
								<span class="font-semibold">
			...
			<div class="lg:col-span-2 xl:col-span-1 space-y-3 xl:space-y-3">
