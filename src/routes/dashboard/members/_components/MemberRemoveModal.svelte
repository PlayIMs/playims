...
>
	...
	<div class="space-y-4 overflow-y-auto bg-neutral-400 p-4">
		<div class="flex items-start gap-3 border-2 border-secondary-300 bg-white p-4">
		...
		<div class="flex flex-col-reverse gap-2 border-t border-secondary-300 pt-3 sm:flex-row sm:justify-end">
