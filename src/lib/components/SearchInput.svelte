<script lang="ts">
	...
	let {
		...
		iconClass = 'absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-neutral-700',
		inputClass = 'input-secondary min-h-10 pl-10 pr-10 py-2 text-sm disabled:cursor-not-allowed',
		clearButtonClass = 'absolute right-2 top-1/2 -translate-y-1/2 text-neutral-700 hover:text-secondary-900 cursor-pointer',
