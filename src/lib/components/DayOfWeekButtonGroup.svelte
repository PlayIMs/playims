<script lang="ts">
	...
	let {
		...
		disabled = false,
		allowClear = true,
		fieldClass = 'border-2 border-secondary-400 bg-white p-1.5 text-neutral-950 focus-within:border-secondary-500 focus-within:shadow-[0_0_0_1px_var(--color-secondary-500)]',
		gridClass = 'grid grid-cols-4 gap-2 sm:grid-cols-7',
		buttonClass = 'min-h-9 border-2 px-2 py-1.5 text-center font-sans text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:border-secondary-500 focus-visible:shadow-[0_0_0_1px_var(--color-secondary-600)] disabled:cursor-not-allowed disabled:opacity-50',
