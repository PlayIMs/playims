...
export const PERMISSIONS = {
	...
	VIEW_COMMUNICATION_HISTORY: 'VIEW_COMMUNICATION_HISTORY', // allows reading message history and message detail
	PREVIEW_COMMUNICATION_AUDIENCE: 'PREVIEW_COMMUNICATION_AUDIENCE', // allows resolving recipient previews and audience targeting
	CREATE_COMMUNICATION_DRAFT: 'CREATE_COMMUNICATION_DRAFT', // allows creating new communication drafts
	EDIT_COMMUNICATION_DRAFT: 'EDIT_COMMUNICATION_DRAFT', // allows editing existing communication drafts
	DELETE_COMMUNICATION_DRAFT: 'DELETE_COMMUNICATION_DRAFT', // allows deleting draft communications
	SEND_COMMUNICATION: 'SEND_COMMUNICATION', // allows transitioning a draft into sent history
	DUPLICATE_COMMUNICATION: 'DUPLICATE_COMMUNICATION', // allows duplicating a message into a new draft
...
const DEFAULT_ROLE_DEFINITIONS = {
	...
	manager: {
		...
		permissions: [
			...
			PERMISSIONS.PREVIEW_COMMUNICATION_AUDIENCE,
			...
			PERMISSIONS.SEND_COMMUNICATION,
			PERMISSIONS.DUPLICATE_COMMUNICATION
		]
	},
	admin: {
		label: 'Admin',
