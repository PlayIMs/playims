...
import { ClubSeasonOperations } from './club-seasons.js';
import { ClubOperations } from './clubs.js';
import { ClubLeagueOperations } from './club-leagues.js';
import { ClubTeamOperations } from './club-teams.js';
import { ClubTeamRosterOperations } from './club-team-rosters.js';
import { ClubOfficerTitleOperations } from './club-officer-titles.js';
import { ClubOfficerAssignmentOperations } from './club-officer-assignments.js';
import { ClubEventOperations } from './club-events.js';
import { LeagueOperations } from './leagues.js';
import { DivisionOperations } from './divisions.js';
import { DivisionStandingsOperations } from './division-standings.js';
...
export class DatabaseOperations {
	...
	public clubSportsSeasons: ClubSeasonOperations;
	public clubSportsClubs: ClubOperations;
	public clubSportsLeagues: ClubLeagueOperations;
	public clubSportsTeams: ClubTeamOperations;
	public clubSportsTeamRosters: ClubTeamRosterOperations;
	public clubSportsOfficerTitles: ClubOfficerTitleOperations;
	public clubSportsOfficerAssignments: ClubOfficerAssignmentOperations;
	public clubSportsEvents: ClubEventOperations;
	public leagues: LeagueOperations;
	public divisions: DivisionOperations;
	public divisionStandings: DivisionStandingsOperations;
	...
	public members: MemberOperations;
	...
	constructor(platformOrDb: { env: { DB: D1Database } } | D1Database, drizzleOptions?: CreateDrizzleClientOptions) {
		...
		this.clubSportsTeams = new ClubTeamOperations(drizzleDb);
		this.clubSportsTeamRosters = new ClubTeamRosterOperations(drizzleDb);
		...
		this.members = new MemberOperations(drizzleDb);
...
export { ClubTeamOperations } from './club-teams.js';
export { ClubTeamRosterOperations } from './club-team-rosters.js';
...
export { MemberOperations } from './members.js';
