...
| SearchInput wrapper            | `relative`                                                                                           |
| SearchInput leading icon       | `absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-950`                                  |
| SearchInput clear button       | `absolute right-2 top-1/2 -translate-y-1/2 text-neutral-950 hover:text-secondary-900 cursor-pointer` |
